...
/* fake parser to allow deparsing of UDP meta, this should normally never be called */
parser parse_udp_meta {
    extract(udp_meta);
    return parse_udp_flow_meta;
}

parser parse_udp_flow_meta {
    extract(udp_flow_meta);
    return parse_tcp_udp;
}
